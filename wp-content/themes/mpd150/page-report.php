				...
				<main class="site-main" id="main" role="main">
						...
						<div class='row justify-content-center'>
							<div class='col-12 col-md-10 col-lg-8'>
								...
								<p class= 'col-12 aligncenter text-center margin-lg'>
							...
							<div id='overview-container' class='col-12 margin-xl'>
								<div class='row'>
									<div class='col-12 col-md-4'>
										...
										<h4 class='alignleft'><a href='/history'>View History Section ></a></h4>
									</div>
									<div class='col-12 col-md-4'>
										<h2>Present</h2>
										<img src='/wp-content/uploads/2017/11/1934-strike-3.png' class='border-black margin-md'>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
										<h4 class='alignleft'><a href='/present'>View Present Section ></a></h4>
									</div>
									<div class='col-12 col-md-4'>
										<h2>Future</h2>
										<img src="/wp-content/uploads/2017/11/1934-strike-3.png" class='border-black margin-md'>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
										<h4 class='alignleft'><a href='/future'>View Future Section ></a></h4>
									</div>
								</div>
							</div>
							<h3 class='margin-xl aligncenter font-weight-light'><a>Download the Report as PDF >></a></h3>
						</div>
